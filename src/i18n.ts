...
const DICT: Array<[string, string, string]> = [
  ...
  ['.hero-marker .right', 'Available · Q2 ’26', 'Verfügbar · Q2 ’26'],
  ...
  ['.hero-tagline', 'AI engineer for early-stage teams.<br>\n      <em>Production systems</em>, shipped solo.',
                    'KI-Ingenieur für junge Teams.<br>\n      <em>Produktionssysteme</em>, solo geliefert.'],
  ...
  ['#index .metric:nth-child(2) .lbl', 'GitHub repositories', 'GitHub-Repositories'],
  ['#index .metric:nth-child(2) .det', 'Public, actively growing', 'Öffentlich, aktiv wachsend'],
  ['#index .metric:nth-child(3) .lbl', 'Zero to seven live', 'Von null auf sieben live'],
  ...
  ['#story .tl-row:nth-child(4) .ttl', 'Production mode · 7 live systems', 'Produktionsmodus · 7 Live-Systeme'],
  ...
  ['#values .value:nth-child(1) p',
    'Spec → architecture → code → deploy → monitor → iterate. No hand-offs, no "not my job". Seven live systems in ten months — solo. The cadence your runway needs.',
    'Spec → Architektur → Code → Deploy → Monitor → Iteration. Keine Übergaben, kein „nicht mein Bier". Sieben Live-Systeme in zehn Monaten — solo. Die Kadenz, die Ihre Runway braucht.'],
  ...
  ['#values .value:nth-child(2) p',
    'LLM pipelines, agent orchestration, RAG-ready patterns, FastAPI/Python, Cloudflare edge, Docker/systemd. One headcount, full stack — your seed runway stretches further.',
    'LLM-Pipelines, Agent-Orchestrierung, RAG-fähige Muster, FastAPI/Python, Cloudflare Edge, Docker/systemd. Eine Person, voller Stack — Ihre Seed-Runway reicht weiter.'],
  ...
  ['#values .value:nth-child(3) p',
    'Multi-provider failover (OpenAI / Gemini / Groq / Ollama). Structured outputs, prompt architectures, voice + vision pipelines, streaming APIs. I design with latency, cost &amp; failure modes in mind.',
    'Multi-Provider-Failover (OpenAI / Gemini / Groq / Ollama). Strukturierte Outputs, Prompt-Architekturen, Voice- + Vision-Pipelines, Streaming-APIs. Ich entwerfe mit Latenz, Kosten &amp; Fehlermodi im Blick.'],
  ...
  ['#values .value:nth-child(5) p',
    "Career-switched at 35+ and shipped seven live systems in ten months while working part-time. Not talent — discipline. I don't need reminders to unblock myself.",
    'Mit 35+ den Beruf gewechselt und sieben Live-Systeme in zehn Monaten geliefert, während ich nebenbei gearbeitet habe. Kein Talent — Disziplin. Ich brauche keine Erinnerungen, um mich selbst zu entblockieren.'],
  ...
  ['#projects .section-title', 'Seven systems.<br>Shipped <em>solo</em>. All live.',
                               'Sieben Systeme.<br><em>Solo</em> geliefert. Alle live.'],
  ...
  // Project 01 — AI Dictaphone
  ['.proj:nth-child(1) .proj-meta .date:nth-child(3)', 'Flagship', 'Flaggschiff'],
  ['.proj:nth-child(1) .tagline', 'Edge voice pipeline · Whisper → LLM · sub-second latency.',
  ...
  ['.proj:nth-child(1) .proj-stat:nth-child(1) .l', 'in production', 'in Produktion'],
  ['.proj:nth-child(1) .proj-stat:nth-child(2) .l', 'cold start', 'Cold-Start'],
  ['.proj:nth-child(1) .proj-stat:nth-child(3) .l', 'webhook auth', 'Webhook-Auth'],
  ['.proj:nth-child(1) .proj-stat:nth-child(4) .l', 'global', 'global'],

  // Project 02 — AI Moderation Bot
  ['.proj:nth-child(2) .tagline', 'n8n workflow · dual-AI failover · auto-escalation.',
  ...
  ['.proj:nth-child(2) .proj-stat:nth-child(1) .l', 'n8n nodes', 'n8n-Knoten'],
  ['.proj:nth-child(2) .proj-stat:nth-child(2) .l', 'AI providers', 'KI-Anbieter'],
  ['.proj:nth-child(2) .proj-stat:nth-child(3) .l', 'sanctions', 'Sanktionen'],
  ['.proj:nth-child(2) .proj-stat:nth-child(4) .l', 'structured', 'strukturiert'],

  // Project 03 — AI Psychology Bot
  ['.proj:nth-child(3) .proj-meta .date:nth-child(3)', 'Monetized SaaS', 'Monetarisiertes SaaS'],
  ['.proj:nth-child(3) .tagline', 'Full SaaS · payments · conversational agent.',
                                  'Komplettes SaaS · Zahlungen · Konversations-Agent.'],
  ...
  ['.proj:nth-child(3) .proj-stat:nth-child(1) .l', 'protocol', 'Protokoll'],
  ['.proj:nth-child(3) .proj-stat:nth-child(2) .l', 'payments', 'Zahlungen'],
  ['.proj:nth-child(3) .proj-stat:nth-child(3) .l', 'credit ops', 'Kredit-Ops'],
  ['.proj:nth-child(3) .proj-stat:nth-child(4) .l', 'revenue', 'Umsatz'],

  // Project 04 — Bushmark
  ['.proj:nth-child(4) .tagline', 'Self-hosted · cookie auth · one-click install.',
  ...
  ['.proj:nth-child(4) .proj-cta', 'Visit bushmark.cc →', 'bushmark.cc besuchen →'],
  ['.proj:nth-child(4) .proj-stat:nth-child(1) .l', 'bash install', 'Bash-Install'],
  ['.proj:nth-child(4) .proj-stat:nth-child(2) .l', 'Ubuntu VPS', 'Ubuntu-VPS'],
  ['.proj:nth-child(4) .proj-stat:nth-child(3) .l', 'history', 'Verlauf'],
  ['.proj:nth-child(4) .proj-stat:nth-child(4) .l', 'slots', 'Slots'],

  // Project 05 — CyberDed Ultra
  ['.proj:nth-child(5) .proj-meta .date:nth-child(3)', 'Open Source', 'Open Source'],
  ['.proj:nth-child(5) .tagline', 'Local AI infra · one-click installer · Android + Linux.',
  ...
  ['.proj:nth-child(5) .proj-cta', 'View on GitHub →', 'Auf GitHub ansehen →'],
  ['.proj:nth-child(5) .proj-stat:nth-child(1) .l', 'streaming', 'Streaming'],
  ['.proj:nth-child(5) .proj-stat:nth-child(2) .l', 'auto-detect', 'Auto-Erkennung'],
  ['.proj:nth-child(5) .proj-stat:nth-child(3) .l', 'MIT', 'MIT'],
  ['.proj:nth-child(5) .proj-stat:nth-child(4) .l', 'Linux + Android', 'Linux + Android'],

  // Project 06 — Termux AI Dictaphone
  ['.proj:nth-child(6) .proj-meta .date:nth-child(3)', 'Open Source', 'Open Source'],
  ['.proj:nth-child(6) .tagline', 'Android as offline AI server · zero cloud cost.',
  ...
  ['.proj:nth-child(6) .proj-cta', 'View on GitHub →', 'Auf GitHub ansehen →'],
  ['.proj:nth-child(6) .proj-stat:nth-child(1) .l', 'offline', 'offline'],
  ['.proj:nth-child(6) .proj-stat:nth-child(2) .l', 'API cost', 'API-Kosten'],
  ['.proj:nth-child(6) .proj-stat:nth-child(3) .l', 'mode', 'Modus'],
  ['.proj:nth-child(6) .proj-stat:nth-child(4) .l', 'privacy', 'Privatsphäre'],

  // "Explore all repos" CTA at bottom of projects
  ['#projects > .reveal:last-child .btn-ghost', 'Explore all 19+ repos on GitHub <span class="arrow">→</span>',
                                                'Alle 19+ Repos auf GitHub erkunden <span class="arrow">→</span>'],

  // ── STACK (§ V) ─────────────────────────────────────────────
  ['#stack .eyebrow', '§ V — Toolkit', '§ V — Werkzeuge'],
  ['#stack .section-title', 'Full-stack AI automation,<br>top to <em>bottom</em>.',
                            'Full-Stack KI-Automatisierung,<br>von oben bis <em>unten</em>.'],
  ['#stack .section-sub',
  ...
  ['.langs .lang:nth-child(4) .lvl',  'A2/B1 · Improving', 'A2/B1 · verbessert sich'],
  ...
  ['.contact-lede',
    "I'm looking for AI Engineer or Founding Engineer roles at early-stage startups (Seed–Series C). I write production code, own features end-to-end, and ship fast. EU citizen, based in Germany, available immediately.",
    'Ich suche eine Stelle als KI-Ingenieur oder Founding Engineer bei Early-Stage-Startups (Seed–Series C). Ich schreibe Produktionscode, übernehme Features end-to-end und liefere schnell. EU-Bürger, in Deutschland, sofort verfügbar.'],
  ...
  ['.contact-cell:nth-child(2) .lbl', 'Phone', 'Telefon'],
  ['.contact-cell:nth-child(4) .lbl', 'Location', 'Standort'],

  // ── FOOTER ──────────────────────────────────────────────────
  ['footer div:nth-child(1)', '<span class="live">●</span> &nbsp;aleksbuss.dev — all systems operational',
                              '<span class="live">●</span> &nbsp;aleksbuss.dev — alle Systeme betriebsbereit'],
  ['footer div:nth-child(2)', '© Aleksejs Buss · 2026 · Set in Fraunces, Geist &amp; JetBrains Mono',
                              '© Aleksejs Buss · 2026 · Gesetzt in Fraunces, Geist &amp; JetBrains Mono'],
