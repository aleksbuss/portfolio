...
const DICT: Array<[string, string, string]> = [
  ...
  ['#values .value:nth-child(1) p',
    'Spec → architecture → code → deploy → monitor → iterate. No hand-offs, no "not my job". Eight systems shipped solo since mid-2025. The cadence your runway needs.',
    'Spec → Architektur → Code → Deploy → Monitor → Iteration. Keine Übergaben, kein „nicht mein Bier". Acht Systeme solo geliefert seit Mitte 2025. Die Kadenz, die Ihre Runway braucht.'],
  ...
  ['#values .value:nth-child(5) p',
    "Career-switched at 35+ and shipped eight systems solo while moving from part-time driving into full-time engineering. Not talent — discipline. I don't need reminders to unblock myself.",
    'Mit 35+ den Beruf gewechselt und acht Systeme solo geliefert — beim Übergang vom Teilzeit-Fahren zur Vollzeit-Entwicklung. Kein Talent — Disziplin. Ich brauche keine Erinnerungen, um mich selbst zu entblockieren.'],
